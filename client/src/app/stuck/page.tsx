        ...
        <main className="page-wrapper">
            <div className="page-container" style={{ margin: "0 auto" }}>
                <div className="page-header">
                    <div className="page-header-left">
                        ...
                        <p className="page-subtitle">
                            Locked on campus? Contact the right people.
                        </p>
                    </div>
                </div>

                <div className="alert-info" style={{ marginBottom: "2rem" }}>
                    You are stuck on campus with no way out? Don&#39;t worry —
                    contact the AERs or directors below.
                </div>
                ...
                <section style={{ marginBottom: "2.5rem" }}>
                    ...
                    >
                        They are responsible for the guard, opening and closing
                        the campus.
                    </p>
                    <div className="contact-grid">
                        <div className="contact-card">
                            ...
                            <p className="contact-description">
                                Responsible for the guard and access.
                            </p>
                            <a
                ...
                <section>
                    ...
                    <p
                        ...
                        style={{ marginBottom: "1rem" }}
                    >
                        Responsible for the campus — they can help in any
                        situation.
                    </p>
                    <div className="contact-grid">
                        <div className="contact-card">
                            <div className="contact-school-name">EPITECH</div>
                            <p className="contact-description">
                                Responsible for the campus and students.
                            </p>
                            <a
